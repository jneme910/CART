...
DROP TABLE IF EXISTS #BAoiAcres;
DROP TABLE IF EXISTS #BAoiSoils;
DROP TABLE IF EXISTS #BAoiTable;
DROP TABLE IF EXISTS #BAoiSoils2;
...
-89.8136700 46.4087896, -89.8137722 46.4123700,  -89.8033180 46.4123976, -89.8031082 46.4088206, -89.8136700 46.4087896
)))', 4326); 
...
INSERT INTO #M2
SELECT TOP 10  1 AS aoiid, areasymbol AS  landunit, mapunit.mukey, muacres AS mapunit_acres
FROM legend
INNER JOIN mapunit ON mapunit.lkey=legend.lkey 
INNER JOIN #G1 ON #G1.mukey=mapunit.mukey
 ;
