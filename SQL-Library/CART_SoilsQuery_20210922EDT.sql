...
SELECT @aoiGeom = GEOMETRY::STGeomFromText('{0}', 4326);   
...
---------- SDA does not allow the update/set command - had to comment this out
...
SELECT LRC.attributename AS rating_name, LRC.rating_value
FROM #LandunitRatingsCART2 LRC
