...
# Introduction
The Aggregate Stability Interpretation provides soil survey users with an inherent soil property-based ranking of soils and map units for predicting the potential suitability. Onsite investigation should be completed to validate the interpretations in this table and to confirm the identity of the soil on a given site. The numbers in the value columns range from 0 to 100. The larger the value, the greater the potential suitability. The soil may have additional limitations.
