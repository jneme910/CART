...
Below are soil data access hits (usage) by hour and day. Typically the median range per hour is about 2k and it ranges between 500  to 7,300 queries (quartile).  

Tuesday and Thursday are the days it’s used the most and the median for a typical day is about 90k. Ranging from 55k to 181K (quartile.) One thing to note there are some extreme values in the 95th percentile that might need to be considered for planning purposes. The metrics also doesn’t look at the complexity of the queries hitting to soil data access. This could be something that impacts the speed of the server.
...
### Metric Charts
 ...
 ![Soil Application by Year](https://jneme910.github.io/CART/TableImages/Soil_Application_By_Year.PNG)

 ![Soil Data Access sum day count from 5/1/2019 to 6/18/2019 ](https://jneme910.github.io/CART/TableImages/Metric_sum_day_count2.PNG) 
 
  ![Soil Data Access sum day count from 5/1/2018 to 6/18/2019 ](https://jneme910.github.io/CART/TableImages/Metric_sum_day_count2.PNG) 
