...
author: "Jason Nemecek,  Doug Slabaugh, Steve Campbell"
date: "`r Sys.Date()`"
output: 
    html_document:
        toc: TRUE
...
### Converts the hydric component count to a value acreage
```{SQL}
...
![Hydric Rating by Map Unit using Component Count](https://jneme910.github.io/CART/TableImages/Hydric_Map_Final_Results.PNG)
